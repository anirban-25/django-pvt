...
from api.fps.camerons import SPOJIT_API_URLS
...
def book(booking, _fp_name, payload, booker):
    ...
    try:
        ...
        url = f"{SPOJIT_API_URL}/webhook/{SPOJIT_API_URLS['book']}?booking_id={booking.pk}"
