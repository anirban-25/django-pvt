...
def get_pricing(
    ...
    LOG_ID = "[BIP DELIVER-ME DIRECT]"  # BUILT-IN PRICING
    ...
    for service_type in service_types:
        ...
        net_price = rule.cost.basic_charge if rule.cost.basic_charge is not None else 0
        ...
        if rule.cost.min_charge is not None and net_price < rule.cost.min_charge:
